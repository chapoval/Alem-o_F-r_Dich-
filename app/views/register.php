                ...
                <div class="card-body">
                    <form method="post" novalidate>
                        <div class="form-group mb-3">
                            ...
                            <input value="<?= definir_valor('nome')?>" type="text" class="form-control" id="fullName" name="nome" placeholder="Insira seu nome completo" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="cpf">CPF:</label>
                            <input value="<?= definir_valor('cpf')?>" type="text" class="form-control" id="cpf" name="cpf" placeholder="Insira seu CPF" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="dob">Data de Nascimento:</label>
                            <input value="<?= definir_valor('dataNascimento')?>" type="date" class="form-control" id="dob" name="dataNascimento" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="email">Email:</label>
                            <input value="<?= definir_valor('email')?>" type="email" class="form-control" id="email" name="email" placeholder="Insira seu email" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="senha">Senha:</label>
                            <input value="<?= definir_valor('senha')?>" type="password" class="form-control" id="senha" name="senha" placeholder="Insira sua senha" required>
                        </div>
