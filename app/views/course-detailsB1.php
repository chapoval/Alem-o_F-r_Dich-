      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <?php if(!$_aluno['cursob1']):?>
              <div class="course-info d-flex justify-content-between align-items-center">
                <a href="ComprarCurso/cursob1">Comprar Curso</a>
              </div>
            <?php endif;?>

            <?php if($_aluno['cursob1']):?>
              <div class="course-info d-flex justify-content-between align-items-center">
                <a href="cursob1">Acessar Curso</a>
              </div>
            <?php endif;?>
