      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <h3>Curso Para Enfermeiros</h3>
            <p>
            Você, enfermeiro(a), está em busca de alavancar sua carreira na área da saúde? Apresentamos o Curso de Alemão especialmente projetado para profissionais como você!

            Por que aprender alemão? Imagine abrir portas para oportunidades globais, aumentar sua competitividade no mercado e aprimorar a comunicação com pacientes e colegas. Esses são apenas alguns dos benefícios que o conhecimento do alemão pode proporcionar.

            O que oferecemos? Nossas aulas são práticas e interativas, focadas no vocabulário médico essencial, simulações de casos reais e fornecendo um certificado reconhecido internacionalmente.
          ...
          <div class="col-lg-4">
            ...
            <?php if(!$_aluno['cursoe']):?>
              <div class="course-info d-flex justify-content-between align-items-center">
                <a href="ComprarCurso/cursoe">Comprar Curso</a>
              </div>
            <?php endif;?>
