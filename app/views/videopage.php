...
<body>
  ...
  <main id="main">
    ...
    <section id="videopage" class="d-flex justify-content-center align-items-center">
        <!-- Colocar Video do Youtube aqui-->
        <div class="embed-responsive embed-responsive-16by9">
        <iframe width="840" height="472" src="https://www.youtube.com/embed/LXb3EKWsInQ?si=0FpcvkZxl24JGD69" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
  </section>
